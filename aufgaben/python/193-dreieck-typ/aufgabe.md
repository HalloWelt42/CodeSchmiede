...
hints:
  - kosten: 0
    text: |
      ...
      "ungueltig" (Dreiecksungleichung verletzt oder Seite <= 0),
      "gleichseitig" (alle drei gleich),
      "gleichschenklig" (mind. zwei gleich),
      "ungleichseitig" (alle verschieden).
  - kosten: 10
    text: |
      Pruefe zuerst Gueltigkeit: alle > 0 UND laengste Seite kleiner
      als Summe der anderen beiden. Dann set-Trick fuer den Typ.
tests_sichtbar:
  - input: [3, 3, 3]
...
| Typ                | Bedingung                           |
|--------------------|--------------------------------------|
| `"ungueltig"`      | mindestens eine Seite ≤ 0 ODER Dreiecksungleichung verletzt |
...
Damit drei Strecken ueberhaupt ein Dreieck bilden koennen, muss die
