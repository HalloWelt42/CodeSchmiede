...
quelle:
  ...
  notiz: Verallgemeinerung von ROT13 fuer beliebigen Shift
lizenz: eigen
autor: HalloWelt42
...
hints:
  - kosten: 0
    text: |
      ROT13 als Spezialfall von Caesar -- aber: Gross-/Kleinschreibung
      bleibt erhalten, Nicht-Buchstaben bleiben unveraendert. Leerzeichen
      und Satzzeichen werden NICHT entfernt.
  - kosten: 15
    text: |
      Pro Zeichen: ist es Großbuchstabe → 'A'-Basis. Kleinbuchstabe →
      'a'-Basis. Sonst → unveraendert. `(ord(c) - basis + n) % 26 + basis`.
tests_sichtbar:
  - input: ["a", 1]
    expected: "b"
  - input: ["Hello, World!", 5]
...
| Sonderzeichen/Leerzeichen | werden entfernt | bleiben unveraendert |
...
Internet-Klassiker -- in Usenet-Foren wurden Spoiler frueher
"verschluesselt", indem man sie mit ROT13 codierte.
